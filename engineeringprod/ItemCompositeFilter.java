...
public class ItemCompositeFilter extends MenuPanel{
	/**
	 * 
	 */
	...
	public ItemCompositeFilter(String id,IActionHandler iActionHandler)
	{
		super(id);
		...
		field.add(new AjaxFormSubmitBehavior(form, "onchange")
		{
			...
			protected void onSubmit(AjaxRequestTarget target)
			{
				...
				{
					PanelAction.actionType=0;//set panel action with 2//edit and delete button is enabled.
					selectedItem = maps.get(kode);
					selectedItem.setKbarang1( null);
					setResponsePage(new ItemCompositePage(selectedItem));
				}
			}
