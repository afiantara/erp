...
public class GeneratePOFilter extends MenuPanel{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private String[] filter=new String[]{"All","No.Bukti","Tanggal","Bulan"} ;
	...
	public GeneratePOFilter(String id)
	{
		super(id);
		init();
			...
			protected void onSubmit(AjaxRequestTarget target)
			{
				try
				{
					...
					if(maps1.containsKey(kode))
					{
						...
						setResponsePage(GeneratePOPage.class,p);
					}
				}
				catch(Exception ex){}
			}
	...
	public void getPRHeaderequest(int idx)
    {
    	...
    	try {
			Object[] response=_service.callServicePurchasing("getPrequisitionHeaderSudahApprovedBelumPO", params,retTypes);
